...
pae 'print unless $.==1' <file> ...       # trim first line from all files
pae 'print if $.==3' <file> ...           # print third line of all files
pae 'print if eof' <file> ...             # print last line of all files
----
