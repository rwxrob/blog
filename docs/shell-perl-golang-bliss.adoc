...
Here's another example (`F`) that puts `awk` to shame:

[source,perl]
----
include::../../dot/scripts/F[]
----

I use this all the time as a Vim filter to eliminate columns in stuff with just `F 2..4,5` type of syntax.
